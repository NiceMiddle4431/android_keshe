...
public class VisualKeyMap {//创建为单例模式
	...
	private VisualKeyMap(){
		...
		hashMap.put("VK_ESC", KeyEvent.VK_ESCAPE);
	...
	public static int getVisualKey(String key){
		String key_upperCase = key.toUpperCase();	//将输入按键指令转换为大写
		Integer integer = hashMap.get(key_upperCase);
		return integer;
	}
}
